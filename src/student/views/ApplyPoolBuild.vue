<template>
  <el-form ref="form" :model="form" label-width="140px" @submit.prevent="onSubmit"
    ...
    <el-row :gutter="40">
      ...
      <el-col :span="12">
        <el-form-item  label="大头贴">
          <el-input v-model="form.cpImg"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row :gutter="40">
    ...
    <el-row :gutter="40">
      <el-col :span="12">
        <el-form-item  label="是否购买保险">
          <el-input v-model="form.cpInsurance"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
    ...
    <el-row :gutter="40">
      <el-col :span="12">
        <el-form-item  label="是否生源地贷款">
          <el-input v-model="form.cpLoan"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
    ...
    <el-row :gutter="40">
      ...
      <el-col :span="12">
        <el-form-item  label="个人申请材料">
          <el-input v-model="form.cpApplications"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row :gutter="40">
      <el-col :span="12">
        <el-form-item  label="特困证明材料">
          <el-input v-model="form.cpSpecialPoor"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item  label="下岗证明材料">
          <el-input v-model="form.cpLaidOff"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row :gutter="40">
      <el-col :span="12">
        <el-form-item  label="残疾证材料">
          <el-input v-model="form.cpDisability"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item  label="低保证材料">
          <el-input v-model="form.cpLowSecurity"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row :gutter="40">
      <el-col :span="12">
        <el-form-item  label="病情证明材料">
          <el-input v-model="form.cpCondition"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item  label="获奖证明材料">
          <el-input v-model="form.cpAwards"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
  </el-form>
...
<script>
  ...
  import {getPoolBuildBaseInfo} from "../api/api.js";
    ...
    data() {
      return {
        form: {
          ...
          "cpGrade": null,
          "cpMajor": "汉语言文学",
          "cpClass": "com.sakura.dev.domain.CpStudent",
          "cpIdCardNo": "110103199005070931",
          "cpBirthday": null,
          "cpNationality": null,
          "cpImg": null,
          "cpPolitical": null,
