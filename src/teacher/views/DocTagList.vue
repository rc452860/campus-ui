<template>
  <section>
    ...
    <!--列表-->
    <el-table :data="list.content" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
              style="width: 100%;">
    ...
    <el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
      <el-form ref="editForm" :model="editForm" label-width="120px" @submit.prevent="onSubmit"
        ...
        <el-form-item label="开放时间">
          <el-col :span="11">
            <el-date-picker type="date" placeholder="选择日期" v-model="editForm.cpStart"
                            style="width: 100%;"></el-date-picker>
          </el-col>
          <el-col class="line" :span="2">-</el-col>
          <el-col :span="11">
            <el-date-picker type="date" placeholder="选择时间" v-model="editForm.cpEnd"
                            style="width: 100%;"></el-date-picker>
          </el-col>
        </el-form-item>
        <el-form-item>
    ...
    <el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
      <el-form ref="addForm" :model="addForm" label-width="120px" @submit.prevent="onSubmit"
        ...
        <el-form-item label="开放时间">
          <el-col :span="11">
            <el-date-picker type="date" placeholder="选择日期" v-model="addForm.cpStart"
                            style="width: 100%;"></el-date-picker>
          </el-col>
          <el-col class="line" :span="2">-</el-col>
          <el-col :span="11">
            <el-date-picker type="date" placeholder="选择时间" v-model="addForm.cpEnd"
                            style="width: 100%;"></el-date-picker>
          </el-col>
        </el-form-item>
        <el-form-item>
      ...
      getList() {
        ...
        requestDocTagList(para).then((res) => {
          if (res.status != 200 || res.data.status != "success") {
            ...
            console.log(this.list.content[0])
